...
<template>
  ...
  >
    ...
    <div
      v-if="!panel.path"
      class="flex-1 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 cursor-pointer"
      @click="onClickEmpty"
    >
    ...
    <!-- Raw view -->
    <div v-else-if="panel.showRaw" class="flex-1 p-4 overflow-auto">
